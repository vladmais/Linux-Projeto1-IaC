...
echo "Criar os Usuários"


useradd carlos -m -s /bin/bash
usermod -p $(openssl passwd -1 Senha123) -G GRP_ADM
...
usermod -p $(openssl passwd -1 Senha123) -G GRP_VEN
...
usermod -p $(openssl passwd -1 Senha123) -G GRP_SEC
